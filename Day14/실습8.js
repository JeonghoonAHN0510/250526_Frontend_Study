...
// // 내 코드
// const product = { };                // product 객체 선언
// product.제품명 = `${제품명}`;
// product.가격 = `${가격}`;
// product.제조사 = `${제조사}`;

// 강사님 코드
// const product = { 제품명, 가격, 제조사 };            // 속성명과 자료의 변수명이 일치하면, 속성명 생략 가능
...
// let A = Object.values( members );                       // A라는 members 배열 선언
...
//         break;
//     }else{
//         A.push( member );                               // A 배열에 입력받은 member 추가
//         break;
//     }
// }
// console.log( A );
...
// }
// let mathEverage = mathSum / 3;
// console.log( mathEverage );
