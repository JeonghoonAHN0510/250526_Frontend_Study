...
console.log( '[예제1]' );
const person1 = { name : '김코딩', age : '20', city : '인천' };
console.log( person1 );

// 예제 2: 객체의 값(Value) 출력하기
// 다음과 같은 book 객체가 있습니다. 반복문을 사용하여 이 객체의 모든 값 을 하나씩 콘솔에 출력하시오.
// 객체 내 모든 값을 배열로 반환 -> 배열[index]를 이용하여 반복문
console.log( '[예제2]' );
const book2 = { title: 'Cracking the Coding Interview', author: 'Gayle Laakmann McDowell', pages: 500 };
const values2 = Object.values( book2 );     // ['Cracking the Coding Interview', 'Gayle Laakmann McDowell', 500]
...
console.log( '[예제3]' );
const person3 = { name: '김코딩', age: 25 };
person3.email = 'qweqwe@qewqwe.com';        // 속성 추가
delete person3.age;                         // 속성 삭제
console.log( person3 );
...
let values4 = product4.price * product4.stock;
console.log( `총 자산가치 : ${values4}` );

// 예제 5: 대괄호 표기법 사용하기
// 다음 user 객체가 있습니다. 대괄호 표기법을 사용하여 job-title 속성의 값('개발자')을 콘솔에 출력하시오.
// 속성명에 특수문자가 들어가면, 대괄호 표기법 사용
console.log( '[예제5]' );
const user5 = {
  name: '김코딩',
  'job-title': '개발자'
...
console.log( 'level' in character7 );
...
console.log( Object.keys( country8 ) );         // Object.keys( 변수명 )
console.log( Object.values( country8 ) );       // Object.values( 변수명 )
...
const product9 = Object.keys( inventory9 );
const stock9 = Object.values( inventory9 );
for (let i = 0; i <= stock9.length - 1; i++){
    if ( stock9[i] < 10 ){
...
for (let i = 0; i <= students10.length - 1; i++){
    values10 = Object.values(students10[i]);
    console.log( `${values10[0]} : ${values10[1]}` );
}
...
for (let i = 0; i <= data11.length - 1; i++){
    const obj11 = data11[i];                // i번째 동 인구정보 호출
    // 테이블 본문 데이터 넣기
    table += `<tr>
                <td> ${ obj11.동별 } </td>
                <td> ${ obj11.세대수 } </td>
    ...
    // console.log( obj11 );
    // 동별 속성값 확인
        // console.log( obj11.동별 );               각 동 이름 출력
        // console.log( obj11.세대수 );             각 동 세대수 출력
        // console.log( obj11["인구수(계)"] );      각 동 인구수(계) 출력
        // console.log( obj11["인구수(남)"] );      각 동 인구수(남) 출력
        // console.log( obj11["인구수(여)"] );      각 동 인구수(여) 출력
}
