...
function func5(){
    ...
    console.log( document.querySelector('#targetBox'));
}
...
for (let i = 0; i <= itemArray.length - 1; i++){
    itemArray[i].style = 'color : green; font-weight : bold;';
}
...
function func9(){
    ...
    input.push(document.querySelector('#itemInput').value);
    document.querySelector('#arrayStatus').innerHTML = `[${input}]`;
}
