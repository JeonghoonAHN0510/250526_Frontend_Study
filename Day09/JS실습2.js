...
let beverage = prompt("원하는 음료를 입력하세요.");
let quantity = prompt("음료 수량을 입력하세요.");
...
let sports = prompt("운동 종류를 입력하세요.");
let time = prompt("운동 시간(분 단위)을 입력하세요.");
const cal = 7;

let totalCal = time * cal;
